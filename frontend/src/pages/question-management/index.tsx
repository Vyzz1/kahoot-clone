import { Button, Flex, Space, Typography, Spin, Empty, Tag, Table, Dropdown, Modal } from "antd";
    ...
    <section className="p-4 md:p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        <Flex justify="space-between" align="center" wrap="wrap" gap="middle">
          ...
          <Space wrap>
            <Button onClick={() => navigate("/admin/quiz-builder")} type="primary">
              Quiz Builder
            </Button>
            <Button onClick={() => navigate("/admin/quiz-management")}>Back to Quizzes</Button>
